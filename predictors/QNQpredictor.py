...
model_path = os.path.join(project_root, 'training_models', 'QNQ_model.keras')
...
def QNQpredictor(img_path, output_box=None):
    # Define class names
...
def QNQ_save_results_to_google_sheets(*args, **kwargs):
