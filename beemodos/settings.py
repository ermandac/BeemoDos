...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'development_secret_key_change_in_production')
...
WSGI_APPLICATION = 'beemodos.wsgi.application'
...
ML_MODEL_PATH = BASE_DIR / 'ml_models' / 'bee_behavior_model.keras'
